FROM ubuntu:16.04
MAINTAINER Alex Manihuruk <alexfmanihuruk@gmail.com>
...
# install php
RUN apt-get install -y --force-yes php7.1-mysql php7.1-curl php7.1-json php7.1-cgi php7.1-fpm php7.1-mbstring php7.1-dom php7.1-gd php7.1-dev \
    php-apcu php7.1-curl php7.1-mcrypt   php-xdebug php-common  php7.1-xml php7.1-zip
